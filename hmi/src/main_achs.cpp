...
int main(int argc, char** argv)
{
    ...
    spinner.start();
    static const std::string PLANNING_GROUP = "achs_controller";
    ...
    std::vector<std::vector<double>> target_positions = {
      {2, -0.4, 0.2, 0, 0, 1.57},  // Target position 1
      {2-0.25 , -0.4, 0.05, 0, 0, -1.57},  // Target position 2
      {2-0.25 , 0.3, 0.2, 0, 0, 1.57},  // Target position 3
      {2.25 , 0.3, 0.05, 0, 0, -1.57},  // Target position 4
      {2.25 , -0.3, 0.2, 0, 0, 1.57},  // Target position 5
      {2-0.25 , -0.4, 0.05, 0, 0, -1.57},  // Target position 2
      {2-0.25 , 0.3, 0.2, 0, 0, 1.57},  // Target position 3
      {2.25 , 0.3, 0.05, 0, 0, -1-.57},  // Target position 4
      {2.25 , -0.3, 0.2, 0, 0, 1.57},  // Target position 5
